...
export function DashboardSidebar() {
  ...
  return (
    <aside className="flex min-h-screen w-60 flex-col bg-ink">
      {/* Brand */}
      <div className="flex items-center gap-2.5 border-b border-white/10 px-5 py-[18px]">
        ...
        <div>
          ...
          <p className="mt-0.5 text-[11px] leading-tight text-slate-400">My Account</p>
        </div>
      </div>
      ...
      {user && (
        <div className="border-b border-white/10 px-5 py-4">
          ...
          <p className="truncate text-sm font-semibold text-white/70">{user.email}</p>
        </div>
      )}
